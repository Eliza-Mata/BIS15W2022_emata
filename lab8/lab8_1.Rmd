...
(1) each variable has its own column  
*No. Some of the columns are variables*  
(2) each observation has its own row  
*No. The observations are columns*  
(3) each value has its own cell  
*Yes. There are no unusual combinations of data in each cell.*   
 ...
 * **some of the of the columns are variables**
 

3. Use `pivot_longer()` to make the data tidy. Focus the data only on genotype, day, and measurement.  
```{r}
plant_data %>%
  pivot_longer(day1:day30, names_to = "day", values_to = "measurement") %>%
